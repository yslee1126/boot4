...
/**
 * Scoped Values 실험 - requestId 전파 컨텍스트
 *
 * ScopedValue는 Java 21+ preview / Java 25 정식 기능으로,
 ...
 * 사용 방법:
 * // 쓰기 (필터 등 진입점에서 한 번만)
 * ScopedValue.runWhere(RequestContext.REQUEST_ID, "req-123", () -> { ... });
 *
...
public final class RequestContext {
    ...
    /**
     * 요청 단위 requestId를 담는 ScopedValue.
     * 필터(RequestIdFilter)에서 바인딩되고, 요청 처리가 끝나면 자동 해제된다.
     */
